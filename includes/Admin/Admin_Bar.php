...
class Admin_Bar
{
    ...
    public function dashboard()
    {
        ...
        $base_apth_admin =  str_replace($parsedUrl['scheme'] . "://" . $parsedUrl['host'], "", get_admin_url());
        wp_enqueue_script('bit-smtp-admin-script', BIT_SMTP_ASSET_URI . '/js/index.js');
        $frontendEnv = apply_filters(
            ...
            array(
                ...
                'baseURL'         => $base_apth_admin . 'admin.php?page=bit-smtp#/',
                'ajaxURL'         => admin_url('admin-ajax.php')
            )
        );

        wp_localize_script('bit-smtp-admin-script', 'bitsmtp', $frontendEnv);
    }
