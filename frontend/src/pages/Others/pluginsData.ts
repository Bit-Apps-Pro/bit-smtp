...
export const pluginsData: PluginInfo[] = [
  ...
  {
    logo: bitFlowsLogo,
    title: 'AI Automation: Build Complex AI Workflow with OpenAI, Gemini, Claude, DeepSeek - Bit Flows',
    description:
    ...
    activeInstalls: '1000+',
    pluginUrl: 'https://wordpress.org/plugins/bit-flow/'
  },
  {
  ...
  {
    logo: bitSocialLogo,
    title: 'Bit Social- Advanced Social Media Schedule & Auto Poster Plugin for WordPress',
    description:
